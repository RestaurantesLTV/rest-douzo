    ...
    <article>
        ...
        <div class="pasos">
            ...
            <div class="pasoInf">
                <div class="paso3">
                    <div>
                        <select name="hora" class="cajaTextoSelect">
                            <option></option>
                            <?php
                            for ($i = 0; $i <= 23; $i++) {
                                if ($i < 10) {
                        ...
                        :<select name="minuto" class="cajaTextoSelect" >
                            <option></option>
                    ...
                    <select name="turno" id="turno" class="cajaTextoSelect">
                        <?php
...
//echo form_submit("reservar", "Reservar");
                ?>
                <input id="submit_reservar" type="submit"  class="btn-succses" value="Reservar"/>
                <?php
                echo form_close();
                ?>
            </div>
        ...
        <script charset="utf-8">
            ...
            cssName: 'default',
                    ...
                    borderSize: 1,
                    // The number of pixels to offset the calendar's position on the page.                         calendarOffset: {x: 0, y: 1},
                    ...
                    //   data : Special data associated with the cell (if available, otherwise, null)                         onClick: (function(el, cell, date, data) {
