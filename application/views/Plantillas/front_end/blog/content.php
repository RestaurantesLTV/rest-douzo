...
<div style="position: relative;">
    <section class="section" id="post-list" >
        <article class="article" id="news-32">
            ...
            <div class="rest">
                <h2>
                    <a href="news/2012/07/16/moonlight-cooking.html" title="Moonlight cooking">Moonlight cooking</a>
                ...
                <div class="text">
                    ...
                    Nulla facilisi. Fusce libero massa, euismod a venenatis a, rutrum sit amet dolor. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Quisque non turpis nisl, nec interdum nunc. Phasellus molestie dolor dui. Integer velit odio, suscipit eget porta in, pretium et nunc. Maecenas ac diam tortor. Integer laoreet posuere ante, ac aliquam metus euismod ac
                    ...
                </div>
                <div class="date">Fecha: 02.07.2012 &#124; <a class="read-more" href="news/2012/07/16/moonlight-cooking.html" title="Moonlight cooking"><span>Leer más...</span><br /></a>
                </div>
